 ...
 * Example: line = "phan thanh tung","van tuan","obama"
 * With:    index_read = 0 => string_read = "phan thanh tung"
 *          index_read = 1 => string_read = "van tuan"
 *          index_read = 3 => string_read = "obama"
 */
...
/**
 * Read lines in file scv
 * Example file csv:    "hoc", cách, làm, "trò chơi"
 *                      "cuộc", sống, ôi, "đẹp quá"
 * string_lines = [
 *      0 => string("hoc", cách, làm, "trò chơi")
 *      1 => string("cuộc", sống, ôi, "đẹp quá")
 * ]
 */
